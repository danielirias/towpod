...
public class clsCategoriaOfrecidaArrayAdapter extends ArrayAdapter<clsCategoria> {

    public clsCategoriaOfrecidaArrayAdapter(Context context, List<clsCategoria> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (null == convertView) {
            ...
            listItemView = inflater.inflate(
                    R.layout.act_add_proveedor_category_item_format,
                    parent,
                    false);
        }
        ...
        TextView txtIDCategoriaRelacionada = (TextView)listItemView.findViewById(R.id.txtIDCategoriaRelacionada);
        txtIDCategoriaRelacionada.setText(item.getIdCategoria());
