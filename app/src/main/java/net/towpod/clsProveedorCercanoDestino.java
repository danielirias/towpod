...
public class clsProveedorCercanoDestino {
    ...
    public clsProveedorCercanoDestino(String IdProveedor, String nombreProveedor, Integer assistance_id, Double service_value, Integer provider_rate,
                                      Double distanciaProveedor, String strPhone_1, String strPhone_2, String strPhone_3, Integer area_id, String area_name, String aprox_time, String country_currency, Double fixed_service_value, Double total_distance, Double distanceUserToDestiny, String carBrand, String carModel, Integer carYear, String carColor, String carID)
    {
    ...
    public String getCarID(){return carColor;}
    public String getCarColor(){return carID;}
