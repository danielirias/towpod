...
public class clsCategoriaArrayAdapter extends ArrayAdapter<clsCategoria> {

    public clsCategoriaArrayAdapter(Context context, List<clsCategoria> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (null == convertView) {
            ...
            listItemView = inflater.inflate(
                    R.layout.act_service_directory_item_format,
                    parent,
                    false);
        }
